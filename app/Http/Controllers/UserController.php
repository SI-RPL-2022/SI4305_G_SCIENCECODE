...
class userController extends Controller
{
    ...
    public function profile(){
        if(!is_login()) return redirect('auth/login');

        $user = new User();
        $userData = Session::get('user');
        $data['profile'] = $user->data('id', $userData->id)->first();
    ...
    public function changeBio(Request $request){
        ...
        $user = new User();
        $userData = Session::get('user');
        $user->updates($input, $userData->id);
        return redirect('dashboard/profile')->with('alert', show_alert('Data profile berhasil diubah', 'success'));
    }
    ...
    public function changePassword(Request $request){
        ...
        $userData = session::get('user');
        $user->updates($input, $userData->id);
        return redirect('dashboard/profile')->with('alert', show_alert('Password berhasil diubah', 'success'));
    }
