				...
				<div class="card shadow">
					...
					<div class="card-body">
						...
						<form method="POST" action="/auth/do_register">
						    ...
						    <input name="name" required="" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama Lengkap">
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <input name="phone" required="" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan No. Handphone">
						  </div>
						  <div class="form-group">
