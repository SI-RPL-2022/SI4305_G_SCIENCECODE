...
<!-- Mirrored from ScienceCode.humatheme.com/Demos/Fixed_Layout/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2022 06:58:36 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <div class="sk-bounce-dot"></div>
        ...
        <div class="mdk-header-layout js-mdk-header-layout">
            ...
            <div class="hero container page__container text-center text-md-left mt-5">
            <div class="row mt-5">
              @if(is_user())
                <div class="col-md-3">
                  <a href="/dashboard">
              ...
              @elseif(is_instructor())
                ...
                <div class="col-md-2">
                  <a href="/dashboard/instructor/course">
                    <div class="card">
                      <div class="card-body">
                        <b>Course</b>
                      </div>
                ...
                <div class="col-md-2">
                  <a href="/dashboard/instructor/discussion">
                    <div class="card">
                      <div class="card-body">
                        <b>Diskusi</b>
                      </div>
            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark-pickled-bluewood sidebar-left"
                    ...
                    <div class="d-flex align-items-center navbar-height">
                        <form action="https://ScienceCode.humatheme.com/Demos/Fixed_Layout/index.html"
                    ...
                    <a href="index.html"
                       class="sidebar-brand ">
                        <!-- <img class="sidebar-brand-icon" src="/images/illustration/student/128/white.svg" alt="ScienceCode"> -->
    ...
    <span class="sidebar-menu-text">Chips</span>
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse sm-indent"
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/Compact_App_Layout/index.html">
                                        <span class="sidebar-menu-text">Compact</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/Mini_App_Layout/index.html">
                                        <span class="sidebar-menu-text">Mini</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/Mini_Secondary_Layout/index.html">
                                        <span class="sidebar-menu-text">Mini + Secondary</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/App_Layout/index.html">
                                        <span class="sidebar-menu-text">App</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/Boxed_App_Layout/index.html">
                                        <span class="sidebar-menu-text">Boxed</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="https://ScienceCode.humatheme.com/Demos/Sticky_App_Layout/index.html">
