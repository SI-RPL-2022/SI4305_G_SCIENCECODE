	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="POST" action="/dashboard/instructor/course/insert_material/quiz/{{$course->course_id}}/{{$course->section_id}}">
					@csrf
					<div class="row mt-3">
						<div class="col-md-12">
							<label>Judul Quiz</label>
							<input type="text" autocomplete="off" class="form-control" required name="material_title" placeholder="Quiz Fundamental Template Blade Laravel">
						</div>
					</div>
